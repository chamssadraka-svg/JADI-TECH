function verifierOuverture() {
    ...
    if (jour === 0 || heureActuelleEnMinutes < heureOuverture1 || heureFermeture1 <= heureActuelleEnMinutes && heureActuelleEnMinutes < heureOuverture2 || heureActuelleEnMinutes >= heureFermeture2) {
